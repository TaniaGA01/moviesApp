...
const radio = ref(20)
const x =ref(30)
const circumference = ref(Math.floor(300))
const pourcentage = ref(Math.floor(parseInt(props.note) * 10))
const noteL = ref(parseInt(props.note).toFixed(1))
const strokeDashoffset = ref(Math.floor((circumference.value - pourcentage.value) - 12 ))
